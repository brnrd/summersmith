 ...
 * [Wiki][wiki]
 * [stackoverflow tag](http://stackoverflow.com/questions/tagged/summersmith)
 * IRC - **#summersmith** on freenode

[website]: https://github.com/jnordberg/summersmith "Summersmith project"
[docs]: https://github.com/jnordberg/summersmith "Summersmith documentation"
[wiki]: https://github.com/jnordberg/summersmith/wiki "Summersmith wiki"
[plugin-listing]: https://github.com/jnordberg/summersmith/wiki/Plugins "Summersmith plugin listing"
[plugin-guide]: https://github.com/jnordberg/summersmith/wiki/Writing-plugins "Summersmith plugin guide"

## Quick-start

First install summersmith using [npm](http://npmjs.org/):

```bash
$ npm install summersmith -g
```

This will install summersmith globally on your system so that you can access the `summersmith` command from anywhere. Once that is complete run:

```bash
$ summersmith new <path>
```
...
Check the `examples/` directory for some inspiration on how you can use summersmith or the [showcase](https://github.com/jnordberg/summersmith/wiki/Showcase) to see what others are doing.
...
filenameTemplate | `:file.html`| outputs filenames and paths according to a template. ([documentation](https://github.com/jnordberg/summersmith/wiki/Page-Plugin#filename-templating))
...
The second one is `filename` which can be used to override the output filename of the page. See [filename templating](https://github.com/jnordberg/summersmith/wiki/Page-Plugin#filename-templating) for advanced usage.
...
## Using summersmith programmatically
...
Summersmith was written by [Bernard Debecker](https://vegetalope.com) and licensed under the [MIT-license](http://en.wikipedia.org/wiki/MIT_License).

The name is a nod to [Johan Nordberg](http://johan-nordberg.com)'s [Wintersmith](https://github.com/jnordberg/wintersmith) and [blacksmith](https://github.com/flatiron/blacksmith) which inspired this project.
